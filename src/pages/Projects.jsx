...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A responsive weather application that provides current weather conditions, forecasts, and interactive maps for multiple locations.",
    ...
    },
    {
      ...
      description:
        "An analytics dashboard for social media metrics with data visualization, reporting features, and trend analysis.",
    ...
    },
    {
      ...
      description:
        "A real-time chat application with group messaging, file sharing, and emoji reactions built with modern web technologies.",
  ...
  return (
    <div id="projects" className="pt-16 min-h-screen bg-gray-50">
